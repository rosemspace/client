...
export const waiAriaAttributeRegExp = /^aria-(?:a(?:ctivedescendant|tomic|utocomplete)|busy|c(?:hecked|o(?:l(?:count|index|span)ntrols)|urrent)|d(?:e(?:scribedby|tails)|i(?:alog|sabled)|ropeffect)|e(?:rrormessage|xpanded)|flowto|grabbed|h(?:aspopup|idden)|invalid|keyshortcuts|l(?:abel(?:ledby)?|evel|ive)|multi(?:line|selectable)|o(?:rientation|wns)|p(?:laceholder|osinset|ressed)|r(?:e(?:adonly|levant|quired)|o(?:ledescription|w(?:count|index|span)))|s(?:e(?:lected|tsize)|ort)|value(?:m(?:ax|in)|now|text))$/i
