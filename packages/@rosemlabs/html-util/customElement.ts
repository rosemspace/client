import { regExp } from '@rosemlabs/std'
 ...
 */
export const pcenCharRegExp: RegExp = /[-.0-9_a-z\u00B7\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u037D\u037F-\u1FFF\u200C\u200D\u203F-\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/ //\u10000-\uEFFFF/
...
export const isReservedPotentialCustomElementName = (name: string): boolean =>
  /^annotation-xml|color-profile|font-face(?:-(?:src|uri|format|name))?|missing-glyph$/.test(
    name
  )

// https://html.spec.whatwg.org/multipage/custom-elements.html#valid-custom-element-name
export const potentialCustomElementNameRegExp: RegExp = regExp(
...
export const isPotentialCustomElementName = (string: string): boolean =>
  potentialCustomElementNameRegExp.test(string)
