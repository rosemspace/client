import defineConfigurableProperties from '@rosemlabs/common-util/defineConfigurableProperties'
import inBrowser from '@rosemlabs/env/inBrowser'
import getGlobalOf from '@rosemlabs/env/getGlobalOf'
import isDocumentElement from '@rosemlabs/dom-util/isDocumentElement'
import isSVGGraphicsElement from '@rosemlabs/dom-util/isSVGGraphicsElement'
