...
import XMLParser, { NamespaceMap, XMLProcessorMap } from '@rosemlab/xml-parser'
import { Attr, StartTag, EndTag, Content } from '@rosemlab/xml-parser/nodes'
import SVGParser, {
  convertElementArrayToRegExp,
  SVGParserOptions,
} from '@rosemlab/svg-parser/SVGParser'
