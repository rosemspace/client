import defineConfigurableProperties from '@rosemlab/common-util/defineConfigurableProperties'
import inBrowser from '@rosemlab/env/inBrowser'
import getGlobalOf from '@rosemlab/env/getGlobalOf'
import isDocumentElement from '@rosemlab/dom-util/isDocumentElement'
import isSVGGraphicsElement from '@rosemlab/dom-util/isSVGGraphicsElement'
